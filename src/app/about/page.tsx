  ...
  return (
    <div className="relative bg-background min-h-screen">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24">
        ...
        <section className="mb-24">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {["Choose a Challenge", "Write Your CSS", "Get Instant Feedback"].map((title, index) => (
              <div key={index} className="p-8 rounded-lg border border-border bg-card hover:bg-card/90 transition-colors shadow-md">
        ...
        {/* Call to Action */}
        <section className="text-center py-24 bg-gradient-to-r from-primary via-accent to-primary rounded-lg shadow-inner">
